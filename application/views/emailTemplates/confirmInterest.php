    ...
    <body>
        ...
        <div class="container">
            <div>
                <div class="title-box">
                    <h1>Famile</h1>
                    <img src="<?php echo  base_url("/assets/img/heartheader.png")?>" />
                </div>
                    ...
                    <div>
                        <div>
                            <div class="profile-box">
                                <h1>Thank you for showing interest, we will intimate your interest.</h1>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="footer">
                    ...
                    <p>
                        You are receiving this email because you are a registered patron of our Match-Making ServiceIf you no longer wish to receive these emails, please login to your account and update your profile status.
Famile is a wholly owned subsidiary of 1D1S Entercon Pvt Ltd
                    </p>
                    <h1>Famile</h1>
                </div>
            </div>
