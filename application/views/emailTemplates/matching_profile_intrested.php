                    ...
                    <div >
                        <div style="    display: flex;
                            ...
                            width: 73px;
                                ...
                                line-height: 17px;
                                white-space: nowrap;">This person is interested in you</p>
                        </div>
...
<div style="display: flex;
        ...
        <div style="display: flex;">
            <div style="">
                    <img src="<?php echo $profile_data['photo'] ?>" style="width: 208px;
height: 227px;
flex-shrink: 0;"/>
            </div>
            <div style="margin-left:10px;    color: #141414;
    font-family: AvertaStd-Regular;
    font-size: 14px;
    font-style: normal;
    font-weight: 400;
    line-height: 18px;">
                <p><?php echo $profile_data['fname']?></p>
                <p><?php echo $profile_data['age'].', '.$profile_data['gender']?></p>
                <p><?php echo $profile_data['city'].', '.$profile_data['state']?></p>
                <p><?php echo $profile_data['profession']?></p>
                <p><?php echo $profile_data['annual_income']?></p>
                <p><?php echo $profile_data['weight'].', '.$profile_data['height']?></p>
                <p><?php echo $profile_data['food'].', '.$profile_data['religion']?></p>
            </div>
        </div>
</div>
                        <div>
    ...
    letter-spacing: 0.48px;">
                            If you are interested, you can click on the button below.
    Famile will text you their phone number, and vice versa.
                            </p>    
                        </div>
                        <div style="display: flex;
    justify-content: center;">
...
color:white;
text-align: center;
padding-top:2px" target="_blank" href='<?php echo  base_url('index.php/cust/ematchingprofileresponse_url/'.$profile_data['url']) ?>' >I am Interested too</a>
                        </div>
                        <div>
...
line-height: 17px; /* 141.667% */
letter-spacing: 0.48px;">
                            Please note that all profiles are of marriage-minded persons only.
Anyone found abusing this service may be reported by <span style="color: #005FDB;
font-family: AvertaStd-Regular;
font-size: 12px;
font-style: normal;
font-weight: 400;
line-height: 17px;
letter-spacing: 0.48px;
text-decoration-line: underline;">Clicking Here</span>.
                            </p>
                        </div>
                    </div>
                </div>
